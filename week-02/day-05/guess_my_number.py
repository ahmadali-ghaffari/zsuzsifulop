...
from_which_number_global = int(input("Give me the first number of the range "))
until_which_number_global = int(input("Give me the last number of the range "))
...
def rounds_and_range(cycle, from_which_number, until_which_number):
    ...
    print("I thought about a number between " + str(from_which_number) + " and " + str(until_which_number) + " ,can you guess it in " + str(cycle) + " steps?")  # nopep8
...
rounds_and_range(cycle_global, from_which_number_global, until_which_number_global)  # nopep8
