...
def banking ():
    ...
    if accounts[0]['account_number'] != account_from and accounts[1]['account_number'] != account_from and accounts[2]['account_number'] != account_from:
        print("404 - account not found for the transfer (account_from) ")
        something_goes_wrong = True
    elif accounts[0]['account_number'] != account_to and accounts[1]['account_number'] != account_to and accounts[2]['account_number'] != account_to:
